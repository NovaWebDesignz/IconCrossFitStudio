...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full max-w-[100%] h-[80vh] sm:h-[91vh] md:h-[100vh] flex items-center justify-end bg-gray-900 mt-[110px] md:mt-[115px] lg:mt-[115px] overflow-hidden mx-auto">
      {/* Glowing Blur Light Effect */}
      <div className="absolute left-6 md:left-8 lg:left-12 xl:left-20 top-[14%] sm:top-[13%] md:top-[20%] lg:top-[21%] w-[260px] sm:w-[410px] h-[268px] sm:h-[350px] md:w-[440px] lg:w-[580px] xl:w-[450px] md:h-[304px] lg:h-[322px] bg-black opacity-65 blur-2xl z-[5]"></div>
      {/* Left Side Text */}
