...
const ShortInfo = () => {
  return (
    <div className="relative w-full max-w-[95%] md:max-w-[98%] h-auto md:h-auto  mt-[45px] rounded-2xl overflow-hidden mx-auto flex flex-col items-center px-6 py-52 text-center bg-gray-100">
      {/* Star Icon */}
